...
# ==============================================================================
# CẤU HÌNH LOGGING VÀ MÔI TRƯỜDNG
# ==============================================================================
...
# SỬA LỖI: Kết nối tới Redis bằng tên service 'redis' thay vì 'localhost'
...
if __name__ == '__main__':
    listen = ['default']
    # Chờ Redis sẵn sàng (quan trọng khi chạy với Docker Compose)
    time.sleep(5)
